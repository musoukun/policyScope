			...
			<ReactMarkdown
				...
				components={{
					...
					pre: ({ className, ...props }) => (
						<pre
							className={cn(
								"mb-4 overflow-x-auto rounded-lg bg-gray-100 p-4 dark:bg-gray-800",
								className
							)}
							{...props}
						/>
					...
					th: ({ className, ...props }) => (
						<th
							className={cn(
								"border border-gray-300 bg-gray-50 px-4 py-2 text-left font-semibold dark:bg-gray-800",
								className
							)}
							{...props}
						/>
